...
def train(model, loader):
    ...
    noImprovementSince = 0 # number of no improvement of character error rate
    ...
    while True:
        ...
        # if best validation accuracy so far, saved model parameters
        if charErrorRate < bestCharErrorRate:
            ...
            open(FilePaths.fnAccuracy, 'w').write(
                'Validation character error rate of saved model: %f%%, Accuracy: %f%%' % (charErrorRate*100.0, wordAccuracy*100.0))
        else:
