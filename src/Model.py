...
class Model:
    ...
    def setupTF(self):
        ...
        # if wnat to use CPU, put config=config in tf.Session()
    ...
    def trainBatch(self, batch):
        ...
        (_, lossVal) = self.sess.run(
            ...
            {self.inputImgs: batch.imgs, self.gtTexts: sparse, self.seqLen: [Model.maxTextLen] * Model.batchSize, self.learningRate: rate}
        )
